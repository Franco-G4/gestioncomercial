...
urlpatterns = [
    ...
    path('general/crear', ProductosCrear.as_view(), name='crear'),
    path('general/editar/<int:pk>', ProductosActualizar.as_view(template_name = "general/actualizar.html"), name='actualizar'),    
